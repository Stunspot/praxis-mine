...
Include Praxis Mine version `1.0.1`, host and version, installation route, exact command or prompt, expected result, observed result, and the output of the relevant validator. Remove credentials, private corpus content, personal information, and unrelated logs.
