AUTHORING_RUN_ID: praxis-mine-hesperos-pages-repair-20260730
...
Procedures identify prerequisites, actions, expected results, failure branches, and safe re-entry. The Pages navigation, calls to action, policy routes, surface-specific images, alternative text, focus treatment, responsive presentation, and Open Graph metadata are part of this pass. Claims preserve the boundary among package structure, host installation, invocation, publication, directory approval, and customer outcome.
